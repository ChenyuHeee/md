...
type SettingsTab = 'general' | 'shortcuts' | 'privacy';
...
export function SettingsModal(props: {
  ...
  return (
    ...
    >
      <div className="settingsTabs" role="tablist" aria-label={t('dialog.settings.title')}>
        <button
          type="button"
          className={tab === 'general' ? 'settingsTab settingsTab--active' : 'settingsTab'}
          role="tab"
          aria-selected={tab === 'general'}
          onClick={() => setTab('general')}
        >
          {t('dialog.settings.sectionGeneral')}
        </button>
        <button
          type="button"
          className={tab === 'shortcuts' ? 'settingsTab settingsTab--active' : 'settingsTab'}
          role="tab"
          aria-selected={tab === 'shortcuts'}
          onClick={() => setTab('shortcuts')}
        >
          {t('dialog.settings.sectionShortcuts')}
        </button>
        <button
          type="button"
          className={tab === 'privacy' ? 'settingsTab settingsTab--active' : 'settingsTab'}
          role="tab"
          aria-selected={tab === 'privacy'}
          onClick={() => setTab('privacy')}
        >
          {t('dialog.settings.sectionPrivacy')}
        </button>
      </div>
